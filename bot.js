   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/5hE7UgF :scroll: **`)
...
if (message.author.id !== '353857391646998528') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
j = 1;	
       ...
       i = i+j;	
        client.user.setGame(setGame[i],`http://www.youtube.com/lucas`);	
}, ms);	
...
message.channel.stopTyping()
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/BNj5ccR**")
...
const sWlc = {}
const premium = ['353857391646998528', '201690882406219776', '358771712839385089', '398518643203506176']
client.on('message', message => {
var prefix = "-";
